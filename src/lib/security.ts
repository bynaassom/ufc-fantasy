export const PROFILE_SELECT_FIELDS =
  "id, nickname, first_name, last_name, role, is_banned, ban_reason, total_points, division, division_confirmed, onboarding_completed, notification_preferences, bio, favorite_fighter_id, created_at, updated_at";
