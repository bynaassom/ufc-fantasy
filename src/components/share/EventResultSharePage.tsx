...
export default function EventResultSharePage({ data, shareUrl, bannerDataUrl, shareImageUrl, shareJpegUrl }: { data: ShareData; shareUrl: string; bannerDataUrl?: string | null; shareImageUrl?: string; shareJpegUrl?: string }) {
      ...
      {status === "public" && (
        <div className="mt-8">
          <ShareActions
            ...
            serverShareImageUrl={shareJpegUrl}
          />
        </div>
      )}
